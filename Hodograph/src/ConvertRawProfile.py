# -*- coding: utf-8 -*-
"""
Created on Thu Jan 11 16:39:04 2024
...
def readProfile(dataSource,subdirs,path,file):
        ...
        if file.endswith(".txt"):
            ...
            if isProfile:  # Read in the data and perform analysis
                ...
                contents = contents.replace("Virt. Temp", "Virt") #Added by konst to avoid error
                #Long. and Lat. may need to be replaced like above
                contents = contents.replace("Long.", "Long")
                contents = contents.replace("Lat.", "Lat")
